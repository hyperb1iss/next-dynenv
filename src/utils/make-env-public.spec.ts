...
describe('makeEnvPublic()', () => {
    ...
    it('should show an info message when env vars are prefixed', () => {
        ...
        expect(eventMock).toHaveBeenCalledWith(`Prefixed environment variable 'FOO'`, undefined)

        expect(eventMock).toHaveBeenCalledWith(`Prefixed environment variable 'BAR'`, undefined)

        expect(eventMock).toHaveBeenCalledWith(`Prefixed environment variable 'BAZ'`, undefined)
    })
    ...
    it('should not log anything when logLevel is set to silent', () => {
        ...
        expect(eventMock).toHaveBeenCalledWith(`Prefixed environment variable 'FOO'`, { logLevel: 'silent' })
    })
})
